...
BASE_OUTPUT_DIR="genrm_train/preli_exp/gt_ans_prompt_new_whole_set"
...
OUTPUT_FILE_WO_Q="${BASE_OUTPUT_DIR}/${MODEL}/${DATASET}/val-r1_qwen_32b-wo_q_whole_set.jsonl"
OUTPUT_FILE_W_Q="${BASE_OUTPUT_DIR}/${MODEL}/${DATASET}/val-r1_qwen_32b-w_q_whole_set.jsonl"
OUTPUT_FILE_XVERIFIER="${BASE_OUTPUT_DIR}/${MODEL}/${DATASET}/val-r1_qwen_32b-xverifier_whole_set.jsonl"
OUTPUT_FILE_XVERIFIER_W_PRED="${BASE_OUTPUT_DIR}/${MODEL}/${DATASET}/val-r1_qwen_32b-xverifier_whole_set_w_pred.jsonl"
# val-r1_qwen_32b-w_q_false_only
# Run without question
# echo "Creating prompts without questions..."
python genrm_train/preli_exp/construct_gt_ans_prompt_whole_set.py \
