...
#         }
#     }' \
#       -- /bin/bash train_grpo_math_tune.sh --dataset_name simplelr_skywork --model_name Qwen-2.5-7B --max_response_length 8192  --train_batch_size 256 --ppo_mini_batch_size 128 --rollout_n 8 --kl_loss_coef 0.0 --entropy_coeffient 0.0 --rollout_gpu_memory_util 0.65 --rollout_tp 2  --clip_ratio_high 0.28  --genrm_enable True --suffix test_data
