...
eval_script_path="sh_with_genrm/eval.sh"
...
if [ "$just_wandb" != "true" ]; then
    # 调用转化和评估脚本
    bash sh_with_genrm/convert_and_evaluate_gpu_nodes.sh \
    "$eval_script_path" \
...
python sh_with_genrm/collect_results.py \
