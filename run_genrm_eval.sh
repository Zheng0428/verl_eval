...
EVAL_FOLDER=eval_results_genrm



# Eval for r1 distilled qwen-1.5B 
DATASETS=( "genrm_skywork")
SPLIT=val-r1_qwen_32b-wo_q
...
LOG_DIR="/mnt/bn/tiktok-mm-5/aiic/users/huangyuzhen/verl/genrm_eval_log"
