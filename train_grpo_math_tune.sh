...
GENRMM_MAX_RESPONSE_LENGTH=4096
GENRMM_TEMPERATURE=0.6
GENRMM_TOP_P=0.95
GENRMM_PROMPT_TYPE="r1_wo_question"
OVERWRITE_RUN_NAME=""
GENRMM_MODEL_PATH=/mnt/hdfs/byte_data_seed_azureb_tteng/user/huangyuzhen/SimpleRL-verl/genrm_models
GENRMM_MODEL_BASED_REWARD_ONLY=False
...
while [[ "$#" -gt 0 ]]; do
  ...
  case "$1" in
    ...
    --genrrm_only) GENRMM_MODEL_BASED_REWARD_ONLY="$2"; shift 2 ;;
...
echo "Genrm Model Based Reward Only: $GENRMM_MODEL_BASED_REWARD_ONLY" | tee -a $LOG_FILE_PATH
...
PYTHONUNBUFFERED=1 python -m verl.trainer.main_ppo \
    ...
    generative_reward.model_based_reward_only=$GENRMM_MODEL_BASED_REWARD_ONLY \
